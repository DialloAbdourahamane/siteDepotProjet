    ...
    function show_form( $user_id = null ) {
        ...
        <div class="wpuf-profile">
            <form name="profile" id="your-profile" action="" method="post">
                ...
                <fieldset>
                    <legend><?php _e( 'Informations Générales' ) ?></legend>

                    <table class="wpuf-table">
                        <tr>
                            <th><label for="user_login1"><?php _e( 'Username' ); ?></label></th>
                            <td><input type="text" name="user_login" id="user_login1" value="<?php echo esc_attr( $profileuser->user_login ); ?>" disabled="disabled" class="regular-text" /><br /><em><span class="description"><?php _e( 'L\'identifiant est inchangeable.' ); ?></span></em></td>
                        </tr>
                        <tr>
                            <th><label for="first_name"><?php _e( 'Prénom(s)' ) ?></label></th>
                            <td><input type="text" name="first_name" id="first_name" value="<?php echo esc_attr( $profileuser->first_name ) ?>" class="regular-text" /></td>
                        </tr>

                        <tr>
                            <th><label for="last_name"><?php _e( 'Nom' ) ?></label></th>
                            <td><input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $profileuser->last_name ) ?>" class="regular-text" /></td>
                        </tr>

                        <tr>
                            <th><label for="display_name"><?php _e( 'Nom visible par le public ' ) ?></label></th>
                            <td>
                ...
                <fieldset>
                   <legend><?php _e( 'Modifier mot de passe' ) ?></legend>

                    <table class="wpuf-table">
                        
                        <tr id="password">
                            <th><label for="pass1"><?php _e( 'Nouveau mot de passe', 'wpuf' ); ?></label></th>
                            <td>
                                <input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /><br /><br />
                            </td>
                        </tr>
                        <tr>
                            <th><label><?php _e( 'Confirmer mot de passe', 'wpuf' ); ?></label></th>
                            <td>
                                <input type="password" name="pass2" id="pass2" size="16" value="" autocomplete="off" />&nbsp;<em><span class="description"></span></em>
                            </td>
                        </tr>
                ...
                <p class="submit">
                    ...
                    <input type="submit" class="wpuf-submit" value="<?php _e( 'Mettre à jour le profil', 'wpuf' ); ?>" name="submit" />
                </p>
            </form>
        </div>
        <?php
